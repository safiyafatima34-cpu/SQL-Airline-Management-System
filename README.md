# ✈️ SQL Airline Management System :-
...
3. Copy and paste the SQL script from the repository
...
This project demonstrates **practical SQL skills** commonly expected for **DBMS, SQL, and Data Analytics roles**.
